...
M.config = function()
  local gl = require('galaxyline')
	...
	local gl_util = require('specs.galaxyline.utils')
  ...
  local function def_mode_color()
    ...
    first_element = {
      ...
      highlight = { colors.section_bg2, colors.section_bg2 }
    },
		vi_mode = {
			provider = function()
        local alias = {
    ...
    file_name = {
			icon = {
				...
				highlight = {require('galaxyline.provider_fileinfo').get_file_icon_color, colors.section_bg2},
			},
      name = {
        provider = 'FileName',
        condition = buffer_not_empty,
        ...
        highlight = {colors.fg, colors.section_bg},
			...
			branch = {
				...
				condition = is_git_workspace,
        separator = ' ',
        separator_highlight = {colors.section_bg, bg_color},
				highlight = {colors.fg, colors.section_bg},
			},
			diff = {
				added = {
					...
					highlight = {colors.fg2, bg_color},
				},
				modified = {
					provider = function()
						return provider_vcs.diff_modified() or '0 '
					end,
					-- icon = string.format('%s', '柳'),
					icon = string.format('%s', ' '),
					condition = is_git_file,
					separator_highlight = {bg_color, bg_color},
    ...
    line_info = {
      provider = 'LineColumn',
      separator = ' ',
      separator_highlight = { colors.section_bg2, colors.bg },
      highlight = { colors.fg2, colors.section_bg2 },
    },
    percent = {
